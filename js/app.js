  ...
  function fromDB(store, x) {
    ...
    if (store === "funcionarios") {
      return {
        ...
        dataAdmissao: x.data_admissao || x.dataAdmissao,
        cpf: x.cpf,
        telefone: x.telefone,
        email: x.email,
        status: x.status,
...
const DashboardPage = {
      ...
      `
        <div class="page-header">
          ...
          <div class="actions no-print">
            <a class="btn btn-primary" href="nova-declaracao.html">
              ＋ Nova Declaração
            </a>

            <a class="btn btn-secondary" href="novo-funcionario.html">
              ＋ Novo Funcionário
            </a>
          </div>
        </div>
  ...
  recentTable(list, funcs) {
    ...
    if (!rows.length) {
      return `
        <div class="empty">
          <strong>Nenhuma declaração</strong>
