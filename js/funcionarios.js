const FuncionariosPage = {
  ...
  async init() {
    ...
    try {
      ...
      /*
        ORDEM ALFABÉTICA
        Ignora diferenças entre maiúsculas,
      ...
      */
      ...
      App.layout(
        ...
        "Gerenciamento de servidores e funcionários",
        ...
        <div class="page-header">
          ...
          <div>
            ...
            <p>
              Cadastre e gerencie os dados dos servidores.
            </p>
    ...
    if (!list.length) {
      ...
      return `
        ...
        <div class="empty">
          ...
          <p>
            Cadastre o primeiro servidor para começar.
          </p>
  ...
  async init() {
    ...
    try {
      ...
      App.layout(
        ...
        "Edição e consulta de dados cadastrais",
...
const NovoFuncionarioPage = {
  ...
  async init() {
    ...
    App.layout(
      ...
      "Cadastro de novo servidor no sistema",
